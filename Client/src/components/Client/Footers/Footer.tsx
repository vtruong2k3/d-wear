      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {/* About Us */}
            <div>
              <h3 className="font-semibold text-gray-900 text-lg mb-4">Về Chúng Tôi</h3>
            ...
            {/* Customer Service */}
            <div>
              <h3 className="font-semibold text-gray-900 text-lg mb-4">Dịch Vụ Khách Hàng</h3>
              <ul className="space-y-3">
                <li>
                  <a href="#" className="text-gray-600 hover:text-red-500 transition-colors text-sm">
                    Câu Hỏi Thường Gặp
            ...
            {/* Newsletter */}
            <div>
              <h3 className="font-semibold text-gray-900 text-lg mb-4">Nhận Thông Báo</h3>
              <p className="text-gray-600 text-sm mb-4">
                Đăng ký để nhận thông báo về sản phẩm mới và các chương trình khuyến mãi hấp dẫn.
              </p>
        ...
        <div className="border-t border-gray-200 py-6">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            <p className="text-gray-600 text-sm mb-4 md:mb-0">
              © 2024 D-WEAR. Tất cả quyền được bảo lưu.
            </p>
