...
import { Modal, Form, Row, Col, Input, Select, Checkbox, Typography } from 'antd';
                ...
                <Row gutter={[8, 8]} style={{ marginTop: 8, marginBottom: 16 }}>
                    <Col span={8}>
                        ...
                        >
                            <Select
                                ...
                                onChange={(value) => {
                                    form.setFieldsValue({ newDistrict: undefined, newWard: undefined });
                                }}
                            >
                    ...
                    <Col span={8}>
                        ...
                        >
                            ...
                            >
                                {districts
                                    .filter(d => d.provinceId === form.getFieldValue('newProvince'))
                                    .map((district) => (
                    ...
                    <Col span={8}>
                        ...
                        >
                            ...
                            >
                                {wards
                                    .filter(w => w.districtId === form.getFieldValue('newDistrict'))
                                    .map((ward) => (
